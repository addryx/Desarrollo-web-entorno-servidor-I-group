<%@page import="com.edix.eventos.modelo.beans.Evento"%>
<%@page import="java.util.List"%>
<%@page import="com.edix.eventos.modelo.repository.EventoDaoImpl"%>
<%@page import="com.edix.eventos.modelo.repository.IntEventoDao"%>
...
<body>
	...
	<h3><a href="/Eventos/alta">Nuevo Evento</a></h3>
	...
	<% for (Evento ele: activos){ %>
		...
		<td><a href="/Eventos/editar/<%= ele.getIdEvento() %>">Editar Evento</a></td>
		<td><a href="/Eventos/eliminar?id=<%= ele.getIdEvento() %>">Eliminar Evento</a></td>
